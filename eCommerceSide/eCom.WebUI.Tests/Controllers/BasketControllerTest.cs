...
namespace eCom.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        [TestMethod]
        public void GetSummeryViewModel()
        {
            IRepository<Basket> baskets = new MockContext<Basket>();
            IRepository<Product> products = new MockContext<Product>();
            IRepository<Order> orders = new MockContext<Order>();
        ...
        public void CheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "msdas741@gmail.com", PinCode = "500038" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("msdas741@gmail.com", "From"), null);
